...
public class DatabaseSeeder implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        createDefaultUser("Super", "Admin", "SUPER_ADMIN", "namyou854@gmail.com", "012345678", SUPER_ADMIN);
        createDefaultUser("User", "User", "USER", "user@gmail.com", "012345679", userRole);
        createDefaultUser("Admin", "Admin", "ADMIN", "admin@gmail.com", "012345680", ADMIN);
    }

    private void createDefaultUser(String firstName, String lastName, String username, String email, String phone, Role role) {
        User user = new User();
